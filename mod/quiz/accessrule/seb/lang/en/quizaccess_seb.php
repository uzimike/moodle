...
$string['enableoverride'] = 'Enable SEB override';
...
$string['privacy:metadata:quizaccess_seb_override'] = 'Safe Exam Browser settings for a quiz override. This includes the ID of the last user to create or modify the settings and the id of the quiz override.';
$string['privacy:metadata:quizaccess_seb_override:overrideid'] = 'ID of the override the settings are attached to.';
$string['privacy:metadata:quizaccess_seb_override:timecreated'] = 'Unix time that the template was created.';
$string['privacy:metadata:quizaccess_seb_override:timemodified'] = 'Unix time that the template was last modified.';
$string['privacy:metadata:quizaccess_seb_override:usermodified'] = 'ID of user who last created or modified the template.';
...
$string['seb:manage_seb_donotrequiresafeexambrowser_override'] = 'Override SEB quiz setting: Do not require Safe Exam Browser';
