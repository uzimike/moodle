...
class access_manager {
     ...
     * @return object 'selects', 'joins' and 'params'.
     */
    public static function get_override_settings_sql($overridetablename = 'quiz_overrides') {
        $allfields = '';
        $alljoins = '';
        $allparams = [];
        ...
        return (object)['selects' => $allfields, 'joins' => $alljoins, 'params' => $allparams];
    }
